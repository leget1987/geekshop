...
with open(".secrets/facebook.json", "r") as f_f:
    facebook = json.load(f_f)

SOCIAL_AUTH_FACEBOOK_KEY = facebook["SOCIAL_AUTH_FACEBOOK_KEY"]
SOCIAL_AUTH_FACEBOOK_SECRET = facebook["SOCIAL_AUTH_FACEBOOK_SECRET"]

with open(".secrets/github.json", "r") as f_g:
    github = json.load(f_g)
